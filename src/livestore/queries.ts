...
export const inputs$ = queryDb(tables.inputs.orderBy('year', 'desc').orderBy('day', 'asc'), {
  label: 'inputs',
})

export const solutions$ = queryDb(tables.solutions.orderBy('year', 'desc').orderBy('day', 'asc').orderBy('part', 'asc'), {
  label: 'solutions',
})
